...
DEFINE_TRANSPORT_SERIALIZER_DESERIALIZER_PTR_V2(RemoteForwarding,
        (Mode, mode),
        (ForwardTo, forwardTo),
        (RemoteBindings, remoteBindings)
)

DEFINE_TRANSPORT_SERIALIZER_DESERIALIZER_ENUM_TYPE(TunnelMode, tString, TUNNEL_MODE_FIELDS_MAP)
