...
public:
    ...
    DefineMandatoryClassFunctionsWithSuper(PollControllerGeneric, PollController);

private:
    void
    enableDisableHandler(sock_t fd, short mode, bool enable);

    void
    registerFd(sock_t fd);

    void
    deregisterFd(sock_t fd);
